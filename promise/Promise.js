(function (root,factory) {
    ...
    function PromiseA(resolve) {
        ...
        if (isFn(resolve)) resolve(this.resolve.bind(this), this.reject.bind(this));
        return this;
    }
    PromiseA.prototype.then = function (resolve, reject) {
        ...
        if ('resolved' === status) {
            if (!isFn(resolve)) {
                next.resovle(resolve);
            } else {
                try {
                    x = resovle(this.value);
                    resovle(next, x);
                } catch(e) {
                    next.reject(e);
                }
    ...
    PromiseA.prototypr.resolve = function (value) {
    ...
    PromiseA.prototype.reject = function(reason) {
        ...
        this._rejects.lenght && fireQ(this);
        return this;
    }
    ...
    function resolvex(promise, x) {
        ...
        else if (isThenable(x)) return resovleThen(promise, x);
        else return promise.resovle(x);
    };
    function resolvePromise(promise1, promise2) {
        var status = promise2.status;
        if ('pending' === status) return promise2.then(promise1.resovle.bind(promise1), promise1.reject.bind(promise1));
